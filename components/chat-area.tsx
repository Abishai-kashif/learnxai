      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="flex-1">
            <div className="bg-muted rounded-lg p-4 mb-2">
              <p className="text-sm text-foreground">
                👋 Hello! I'm your AI learning assistant. I'm here to help you
                learn any topic through personalized conversations and
                interactive quizzes.
              </p>
        ...
        <div className="flex gap-3 justify-end">
          <div className="bg-orange-500 text-white rounded-lg p-4 max-w-md">
            <p className="text-sm">
              I want to learn about machine learning algorithms. Can you help me
          ...
          <div className="flex-1">
            <div className="bg-muted rounded-lg p-4 mb-4">
              <p className="text-sm mb-4 text-foreground">
                Excellent choice! Machine learning algorithms can be categorized
                into several main types. Let me break this down for you:
              </p>
              ...
              <div className="bg-orange-50 dark:bg-orange-950 rounded-lg p-4 mb-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <Card className="p-4 text-center">
                    ...
                    <p className="text-xs text-muted-foreground mb-3">
                      Learns through interaction and reward systems
                    </p>
              ...
              <p className="text-sm mb-4 text-foreground">
                ...
                or shall I create a quiz to test your understanding so far?
              </p>
        ...
        <div className="flex gap-3 justify-end">
          <div className="bg-orange-500 text-white rounded-lg p-4 max-w-md">
            <p className="text-sm">
              That's really helpful! Can you create a quiz to test my
              understanding?
            </p>
          </div>
          <Avatar className="w-8 h-8">
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1">
            <div className="bg-muted rounded-lg p-4 mb-4">
              <p className="text-sm mb-4 text-foreground">
                Perfect! I've generated a personalized quiz based on our
                conversation. Let's test your understanding of machine learning
                algorithms:
              </p>
              ...
              <Card className="p-4 border-2 border-orange-200 dark:border-orange-800">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        5 questions • Estimated time: 3 minutes
                      </p>
                    </div>
                  </div>
                ...
                <div className="mb-4">
                  <h4 className="font-medium mb-3 text-foreground">
                    Which type of machine learning algorithm learns from labeled
